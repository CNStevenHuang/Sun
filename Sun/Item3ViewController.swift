...
class Item3ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let image = UIImage(named:"luntang.png")?.imageWithRenderingMode(UIImageRenderingMode.Automatic);
        let selimage = UIImage(named:"luntang.png")?.imageWithRenderingMode(UIImageRenderingMode.AlwaysOriginal);
